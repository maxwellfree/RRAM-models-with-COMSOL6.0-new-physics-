function [con,Ime,Vme,Tmax,TimeLine]= ...
          FindResetTrans(n,Ea,Rtop,Rbottom,Amplitude,threeD,ExportData)
% FindResetTrans
% --------------------------------------------------------------
...
while (logicalreset)
    ...
    if (logicalreset)
        ...
        % reset process.
        model.result.numerical('max1').setIndex('looplevelinput', 'interp', 0);
...
%% Example call:
% [con,Ime,Vme,Tmax,TimeLine]=FindResetTrans(990,1.08,4,1,1.0e7,false,true)
